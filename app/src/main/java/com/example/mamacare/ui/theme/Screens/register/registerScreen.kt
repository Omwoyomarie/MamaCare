package com.example.mamacare.ui.theme.Screens.register
...
fun registerScreen(navController: NavController){
    ...
    Box(){
        Image(painter = painterResource(id = R.drawable.pregnancy),
...
//                .background(Color.LightGray)
        ...
        Image(painter = painterResource(id = R.drawable.maternity),
        ...
        OutlinedTextField(value =username,
            ...
            placeholder = { Text("please enter your username",color = Color.Black) },
...
//                focusedBorderColor = Color.Blue,
        ...
        OutlinedTextField(value =fullname,
            ...
            placeholder = { Text("please enter your fullname",color = Color.Black) },
            textStyle = TextStyle(color = Color.Black),
            leadingIcon = { Icon(Icons.Default.Person, contentDescription = "Person icon") },
            modifier = Modifier.fillMaxWidth(0.8f),
            shape = RoundedCornerShape(16.dp),
...
//                focusedBorderColor = Color.Blue,
        ...
        OutlinedTextField(value =  confirmpassword,
            ...
            placeholder = { Text("please confirm password",color = Color.Black) },
            visualTransformation = PasswordVisualTransformation(),
